...
class OceanographicFeatureCreator:
    ...
    def create_oceanographic_features(self, df):
        """Create oceanographic features from synthetic data"""
    ...
    def remove_temporal_features(self, df):
        ...
        print("Removing temporal features...")
    ...
    def validate_features(self, df):
        ...
        if temporal_features:
            print(f"  Warning: Found potential temporal features: {temporal_features}")
        else:
        ...
        if high_corr_features:
            print(f"  Warning: High correlation features (>0.3): {high_corr_features}")
        else:
    ...
    def create_oceanographic_training_data(self):
        ...
        metadata = {
            ...
            'feature_categories': {
                ...
                'oceanographic': [col for col in df.columns if any(keyword in col for keyword in ['sst', 'ssh', 'current', 'chl', 'sss', 'precip', 'thermal', 'productivity'])],
