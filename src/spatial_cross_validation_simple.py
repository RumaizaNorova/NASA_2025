...
class SpatialCrossValidator:
    ...
    def load_oceanographic_data(self):
        ...
        if not data_path.exists():
            print("  Oceanographic data not found. Please run create_oceanographic_features_simple.py first")
            return None
    ...
    def create_spatial_folds(self, df, n_folds=5):
        ...
        print(f"Creating {n_folds} spatial folds...")
    ...
    def evaluate_spatial_performance(self, fold_scores, fold_predictions, fold_targets):
        ...
        if is_realistic:
            ...
            print("  Performance may be unrealistic - check for data leakage")
        ...
        return {
            ...
            'is_realistic': bool(is_realistic)
        }
    ...
    def run_spatial_cross_validation(self):
        ...
        try:
            ...
            print("Spatial validation prevents data leakage")
