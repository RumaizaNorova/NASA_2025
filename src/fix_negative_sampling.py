...
class NegativeSamplingFixer:
    ...
    def create_fixed_negative_samples(self, shark_obs, num_negative_samples):
        ...
        for i in range(num_negative_samples):
            ...
            dt = datetime.combine(date.date(), datetime.min.time().replace(hour=hour))
    ...
    def create_fixed_training_data(self):
        ...
        if not is_valid:
            print("  ⚠️ Warning: Temporal distribution validation failed")
        else:
        ...
        metadata = {
            ...
            'temporal_validation_passed': is_valid,
